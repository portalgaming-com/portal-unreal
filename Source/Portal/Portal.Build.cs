...
public class Portal : ModuleRules
{
    public Portal(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        if (Target.Platform == UnrealTargetPlatform.Android)
        {
            ...
            AdditionalPropertiesForReceipt.Add("AndroidPlugin", Path.Combine(PluginPath, "Portal_UPL_Android.xml"));
        }
        ...
        if (Target.Platform == UnrealTargetPlatform.IOS)
        {
            ...
            PrivateIncludePaths.AddRange(new string[] { Path.Combine(ModuleDirectory, "Private/Portal", "IOS") });
        ...
        {
            PrivateIncludePaths.AddRange(new string[] { Path.Combine(ModuleDirectory, "Private/Portal", "Mac") });
